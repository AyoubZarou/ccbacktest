...
class DiffAndUpdateTest(unittest.TestCase):
    def test_all(self):
        # a here represents closed intervals, it's equivalent to [[0, 1], [2, 8], [10, 20]]
        # it's just more convenient to use a flat representation
        a = [0, 1, 2, 8, 10, 20]
    ...
    def test_fail(self):
        ...
        self.assertRaises(AssertionError, get_diff_and_update, [0], [4, 8])
        self.assertRaises(AssertionError, get_diff_and_update, [0, -1], [4, 8])
